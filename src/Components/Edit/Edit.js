...
const Edit = () => {
    ...
    const handleUpdate = event => {
        ...
        fetch(`http://localhost:5000/studentsEdit/${information?._id}`, {
            method: 'PUT',
        ...
        <div className='w-full mb-5'>
            <div className=''>
                <div className='mb-3 flex justify-center'>
                    <h1 className='text-3xl text-green-500 font-bold'>Update Info {information.firstName}</h1>
                </div>
                ...
                <div className='flex justify-center'>
                    <form className='w-full' onSubmit={handleUpdate}>
                        <div className='flex gap-2'>
                            <input onChange={handleChange} name="firstName" defaultValue={information?.firstName} className="mt-2 input input-bordered w-full " /> <br />
                            <input onChange={handleChange} name="lastName" defaultValue={information?.lastName} className="mt-2 input input-bordered w-full " /> <br />
                        </div>
                        <div className='flex gap-2'>
